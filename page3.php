...
if(isset($_GET['finish'])){
    ...
    fwrite($fichero, "Nombre: $nombre" . PHP_EOL);
...
<body class="pagina3">
    ...
    <div class="Formulario3">
        ...
        <h2>Step 3</h2>
        <div class="Inputs3">
            Nombre: <input type="text" name="nombre" value="<?php echo $nombre ?>" style="width:20%; margin-right: 10%" disabled>
            Apellido: <input type="text" name="apellido"  value=""disabled><br>
            Email: <input type="text" name="email"  value="" disabled>
            Telefono: <input type="text" name="telefono" value=""style="width:23%"  disabled><br>
            Password: <input type="text" name="password"  value=""style="width:18%; margin-right: 10%" disabled>
